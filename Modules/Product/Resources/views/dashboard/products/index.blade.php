...
@section('title', __('product::dashboard.products.routes.index'))
@section('content')
    ...
    <div class="page-content">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="#">{{__('product::dashboard.products.routes.index')}}</a>
                </li>
            </ul>
        </div>
                        ...
                        <table class="table table-striped table-bordered table-hover" id="dataTable">
                            <thead>
                                <tr>
                                    ...
                                    <th>#</th>
                                    <th>{{__('product::dashboard.products.datatable.image')}}</th>
                                    <th>{{__('product::dashboard.products.datatable.status')}}</th>
                                    <th>{{__('product::dashboard.products.datatable.title')}}</th>
                                    <th>{{__('product::dashboard.products.datatable.created_at')}}</th>
                                    <th>{{__('product::dashboard.products.datatable.options')}}</th>
                                </tr>
                            </thead>
                        </table>
                    </div>
      ...
      $('#dataTable').DataTable({
          ...
          columnDefs: [
      			...
      			},
            {
              targets: -1,
              width: '13%',
              title: '{{__('product::dashboard.products.datatable.options')}}',
              className: 'dt-center',
              orderable: false,
              render: function(data, type, full, meta) {
