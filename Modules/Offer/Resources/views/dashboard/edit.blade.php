                                        ...
                                        <ul class="nav nav-pills nav-stacked">
                                            ...
                                            {{-- <li>
                                                <a href="#seo" data-toggle="tab">
                                                    {{ __('offer::dashboard.offers.form.tabs.seo') }}
                                            </a>
                                            </li> --}}
                                        </ul>
                                    </div>
                            ...
                            <div class="tab-pane active fade in" id="global_setting">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane fade in {{ ($code == locale()) ? 'active' : '' }}" id="colored-rounded-tab-general-{{$code}}">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" name="title[{{$code}}]" class="form-control" data-name="title.{{$code}}" value="{{ $offer->translate($code)->title }}" {{ (is_rtl($code) == 'rtl') ? 'dir=rtl' : '' }}>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <select name="vendor_id[]" id="single" class="form-control select2" data-name="vendor_id" multiple>
                                                <option value=""></option>
                                                @foreach ($vendors as $vendor)
                                                <option value="{{ $vendor['id'] }}" {{ ($offer->vendors->contains($vendor->id)) ? 'selected' : '' }}>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            <span class="holder" style="margin-top:15px;max-height:100px;">
                                              <img src="{{url($offer->image)}}" style="height: 15rem;">
                                            </span>
