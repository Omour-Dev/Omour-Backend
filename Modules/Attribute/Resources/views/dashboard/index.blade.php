      ...
      $('#dataTable').DataTable({
          ...
          columnDefs: [
      			...
      			},
            {
              targets: -1,
              width: '13%',
              title: '{{__('attribute::dashboard.attributes.datatable.attributes')}}',
              className: 'dt-center',
              orderable: false,
              render: function(data, type, full, meta) {
