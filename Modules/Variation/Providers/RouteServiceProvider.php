...
{
    protected $apiModule       = '\Modules\Variation\Http\Controllers\Api';
    protected $frontendModule  = '\Modules\Variation\Http\Controllers\Frontend';
    protected $dashboardModule = '\Modules\Variation\Http\Controllers\Dashboard';
    protected $vendorModule    = '\Modules\Variation\Http\Controllers\Vendor';
    ...
    protected function mapVendorRoutes()
    {
       ...
       ->namespace($this->vendorModule)->group(function() {
           ...
           if (File::allFiles(module_path('Variation', 'Routes/vendor'))) {
    ...
    protected function mapApiRoutes()
    {
        Route::group(['prefix'=>'api' ,'middleware' => ['api'] , 'namespace' => $this->apiModule],function() {
            ...
            foreach (File::allFiles(module_path('Variation', 'Routes/api')) as $file) {
                require_once($file->getPathname());
            }
