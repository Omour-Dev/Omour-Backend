...
class RouteServiceProvider extends ServiceProvider
{
     ...
     protected $vendorModule    = '\Modules\Authorization\Http\Controllers\Vendor';
     ...
     protected function mapVendorRoutes()
     {
        ...
        ->namespace($this->vendorModule)->group(function() {
            ...
            if (File::allFiles(module_path('Authorization', 'Routes/vendor'))) {
                foreach (File::allFiles(module_path('Authorization', 'Routes/vendor')) as $file) {
