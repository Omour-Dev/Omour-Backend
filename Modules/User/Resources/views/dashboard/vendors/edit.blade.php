...
@section('title', __('user::dashboard.vendors.update.title'))
@section('content')
    ...
    <div class="page-content">
            ...
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="{{ url(route('dashboard.sellers.index')) }}">
                        {{__('user::dashboard.vendors.index.title')}}
                    </a>
                    <i class="fa fa-circle"></i>
                </li>
                <li>
                    <a href="#">{{__('user::dashboard.vendors.update.title')}}</a>
                </li>
            </ul>
        </div>
        ...
        <div class="row">
            <form id="updateForm" user="form" class="form-horizontal form-row-seperated" method="post" enctype="multipart/form-data"
                action="{{route('dashboard.sellers.update',$user->id)}}">
                @csrf
                @method('PUT')
                <div class="col-md-12">
                                        ...
                                        <ul class="nav nav-pills nav-stacked">
                                            <li class="active">
                                                <a href="#global_setting" data-toggle="tab">
                                                    {{ __('user::dashboard.vendors.update.form.general') }}
                                                </a>
                                            </li>
                                        </ul>
                                    </div>
                    ...
                    <div class="col-md-9">
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active fade in" id="global_setting">
                                <h3 class="page-title">{{__('user::dashboard.vendors.update.form.general')}}</h3>
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <label class="col-md-2">
                                            {{__('user::dashboard.vendors.update.form.name')}}
                                        </label>
                                        <div class="col-md-9">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2">
                                            {{__('user::dashboard.vendors.update.form.email')}}
                                        </label>
                                        <div class="col-md-9">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2">
                                            {{__('user::dashboard.vendors.update.form.mobile')}}
                                        </label>
                                        <div class="col-md-9">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2">
                                            {{__('user::dashboard.vendors.update.form.password')}}
                                        </label>
                                        <div class="col-md-9">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2">
                                            {{__('user::dashboard.vendors.update.form.confirm_password')}}
                                        </label>
                                        <div class="col-md-9">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2">
                                            {{__('user::dashboard.vendors.update.form.roles')}}
                                        </label>
                                        <div class="col-md-9">
                                            <div class="mt-checkbox-list">
                                                @foreach ($roles as $role)
                                                <label class="mt-checkbox">
                                                    <input type="checkbox" name="roles[]" value="{{$role->id}}" {{ $user->roles->contains($role->id) ?
                                                    'checked=""' : ''}}>
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2">
                                            {{__('user::dashboard.vendors.update.form.image')}}
                                        </label>
                                        <div class="col-md-9">
