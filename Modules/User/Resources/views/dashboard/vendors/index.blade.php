...
@section('title', __('user::dashboard.vendors.index.title'))
@section('content')
    ...
    <div class="page-content">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="#">{{__('user::dashboard.vendors.index.title')}}</a>
                </li>
            </ul>
        </div>
                        ...
                        <table class="table table-striped table-bordered table-hover" id="dataTable">
                            <thead>
                                <tr>
                                    ...
                                    <th>#</th>
                                    <th>{{__('user::dashboard.vendors.datatable.image')}}</th>
                                    <th>{{__('user::dashboard.vendors.datatable.name')}}</th>
                                    <th>{{__('user::dashboard.vendors.datatable.email')}}</th>
                                    <th>{{__('user::dashboard.vendors.datatable.mobile')}}</th>
                                    <th>{{__('user::dashboard.vendors.datatable.created_at')}}</th>
                                    <th>{{__('user::dashboard.vendors.datatable.options')}}</th>
                                </tr>
                            </thead>
                        </table>
                    </div>
      ...
      $('#dataTable').DataTable({
          ...
          columnDefs: [
      			...
      			},
            {
              targets: -1,
              width: '13%',
              title: '{{__('user::dashboard.vendors.datatable.options')}}',
              className: 'dt-center',
              orderable: false,
              render: function(data, type, full, meta) {
