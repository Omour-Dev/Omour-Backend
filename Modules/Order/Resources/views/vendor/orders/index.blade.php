        ...
        <div class="row">
            <div class="col-md-12">
                <div class="portlet light bordered">
                        ...
                        <table class="table table-striped table-bordered table-hover" id="dataTable">
                            <thead>
                                <tr>
                                    ...
                                    <th>#</th>
                                    <th>{{__('order::vendor.orders.datatable.vendor')}}</th>
                                    <th>{{__('order::vendor.orders.datatable.user')}}</th>
                                    <th>{{__('order::vendor.orders.datatable.total')}} - {{ setting('default_currency') }}</th>
                    ...
                    <div class="row">
                        <div class="form-group">
                            <button type="submit" id="deleteChecked" class="btn red btn-sm" onclick="deleteAllChecked('{{ url(route('vendor.orders.deletes')) }}')">
