                                    ...
                                    <div class="col-xs-12 table-responsive">
                                        <table class="table table-striped table-hover">
                                            <thead>
                                                <tr>
                                                    <th class="invoice-title uppercase text-center">
                                                        {{ __('order::vendor.orders.show.area') }}
                                                    </th>
                                                    <th class="invoice-title uppercase text-center">
                                                        {{__('order::vendor.orders.show.street')}}
                                                    </th>
                                                    <th class="invoice-title uppercase text-center">
                                                        {{__('order::vendor.orders.show.building')}}
                                                    </th>
                                                    <th class="invoice-title uppercase text-center">
                                                        {{__('order::vendor.orders.show.floor')}}
                                                    </th>
                                                    <th class="invoice-title uppercase text-center">
                                                        {{ __('order::vendor.orders.show.address_note') }}
                                                    </th>
                                                    <th class="invoice-title uppercase text-center">
                                                        {{__('order::vendor.orders.show.username') }}
                                                    </th>
                                    ...
                                    <div class="col-xs-12 table-responsive">
                                        <table class="table table-striped table-hover">
                                            <thead>
                                                <tr>
                                                    <th class="invoice-title uppercase text-center">
                                                        {{__('order::vendor.orders.show.product_title')}}
                                                    </th>
                                                    <th class="invoice-title uppercase text-center">
                                                        {{__('order::vendor.orders.show.product_price')}}
                                                    </th>
                                                    <th class="invoice-title uppercase text-center">
                                                        {{__('order::vendor.orders.show.product_qty')}}
                                                    </th>
                                                    <th class="invoice-title uppercase text-center">
                                                        {{__('order::vendor.orders.show.total')}}
                                                    </th>
                                                    <th class="invoice-title uppercase text-center">
                                                        {{__('order::vendor.orders.show.options')}}
                                                    </th>
                                                    <th class="invoice-title uppercase text-center">
                                                        {{__('order::vendor.orders.show.addons')}}
                                                    </th>
                                                </tr>
                                            </thead>
                                            <tbody>
                            ...
                            <form id="updateForm" role="form" class="form-horizontal form-row-seperated" method="post" enctype="multipart/form-data" action="{{ route('vendor.orders.update',$order['id']) }}">
                                ...
                                <div class="form-group">
                                    <label class="col-md-2">
                                        {{__('order::vendor.orders.show.driver')}}
