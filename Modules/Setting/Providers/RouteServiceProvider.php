...
class RouteServiceProvider extends ServiceProvider
{
     ...
     protected $vendorModule    = '\Modules\Setting\Http\Controllers\Vendor';
     ...
     protected function mapVendorRoutes()
     {
        ...
        ->namespace($this->vendorModule)->group(function() {
            ...
            if (File::allFiles(module_path('Setting', 'Routes/vendor'))) {
                foreach (File::allFiles(module_path('Setting', 'Routes/vendor')) as $file) {
